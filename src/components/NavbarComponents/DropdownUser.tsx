...
const DropdownUser = () => {
  ...
  const { full_name, position } = useAppSelector(selectAuth);
    ...
    <div className="relative">
      ...
      >
        ...
        <span className="h-12 w-12 rounded-full">
          <img src={"/public/icons/user_profile.svg"} alt="User" />
        </span>
      ...
      >
        ...
        <button onClick={()=>dispatch(logout())} className="hover:text-primary flex items-center gap-3.5 px-6 py-4 text-sm font-medium duration-300 ease-in-out lg:text-base whitespace-nowrap">
          <svg
